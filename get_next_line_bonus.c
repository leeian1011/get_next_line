...
/*   Updated: 2024/11/19 13:43:02 by ialee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// string.
void	*ft_joinswap(char **loaded_buffer, char *scratch)
{
	char	*swap_temp;
...
char	*ft_bufload(int fd, char **loaded_buffer)
{
	char	*scratch;
	int		read_count;
...
int	ft_bufadj(char **loaded_buffer)
{
	int		buf_index;
	char	*temp_buffer;
	char	*nl_addr;
